...
#define PM_SETOUT(port,bit) (DDR##port |= (uint8_t)((1<<(bit))))
#define PM_SETIN(port,bit) (DDR##port &= (uint8_t)(~(1<<(bit))))
#define PM_SETPULLUP(port,bit) (PORT##port |= (uint8_t)((1<<(bit))))
#define PM_SETHIZ(port,bit) (PORT##port &= (uint8_t)(~(1<<(bit))))
...
#define PM_SETL(port,bit,dummy) (PORT##port &= (uint8_t)(~(1<<(bit))))
#define PM_SETH(port,bit,dummy) (PORT##port |= (uint8_t)((1<<(bit))))
...
// #  define PM_CPL(port,bit,val)      (PIN##port |= (uint8_t)((1 << (bit))))
// #else
#  define PM_CPL(port,bit,val)      (PORT##port ^= (uint8_t)((1 << (bit))))
// #endif
